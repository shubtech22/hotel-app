...
//	public Booking(long hotelId, long roomId, String u1, String shubpol, boolean feedGiven, int i, int i1, int numOfGuests, String success, double finalPrice) {
//	}

//	public Booking(int i, long l, long l1, String s, String vikas, boolean b) {
//	}
